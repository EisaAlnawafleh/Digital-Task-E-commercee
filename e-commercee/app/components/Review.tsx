  ...
  return (
    <section data-aos="fade-down" className="py-24  mx-auto px-8 flex-wrap">
      ...
      <div className="flex flex-row flex-wrap justify-center items-center  gap-7">
        <div className="bg-surface-container-high p-10 w-full sm:w-[48%] lg:w-[30%] flex flex-col justify-between bg-[#131313] rounded-3xl">
        ...
        <div className="bg-surface-container-high w-full sm:w-[48%] lg:w-[30%] bg-[#131313] flex flex-col justify-between p-10 rounded-3xl">
          <div className="flex gap-1 mb-6 text-primary">
            {[...Array(5)].map((_, i) => (
              <span key={i} className="material-symbols-outlined">
                <i className="ri-star-line text-[#1fb6cd]"></i>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-on-surface-variant">Tech Journalist</p>
            </div>
          </div>
        </div>
      </div>
