  ...
  return (
    <div data-aos="fade-down">
      <div
        ...
        className="pb-5 flex flex-col gap-5 md:gap-8 lg:gap-10 justify-center items-center pt-20 md:pt-30 lg:pt-50 text-[#898787] px-5 md:px-10"
      >
        <div>CURATED COLLECTIONS</div>

        <div className="flex flex-col lg:flex-row gap-5 w-full max-w-300">
          <div className="cursor-pointer rounded-3xl w-full lg:w-120 p-8 relative overflow-hidden group">
          ...
          <div className="flex flex-col gap-5 md:gap-8 text-white w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <div
                ...
                className="w-full sm:w-1/2 h-60 cursor-pointer group rounded-2xl relative overflow-hidden"
              >
              ...
              >
                ...
                <Image
                  ...
                  className="w-24 h-24 absolute -bottom-2.5 right-0 opacity-75 group-hover:scale-110 transition duration-300"
                />
              </div>
            </div>
            <div
              style={{ background: "var(--card)", color: "var(--text)" }}
              className="=cursor-pointer rounded-3xl p-6 md:p-8 relative overflow-hidden h-60 group"
            >
