    ...
    >
      <div className="flex flex-col gap-6 md:gap-10  text-center lg:text-left items-center lg:items-start">
        ...
        <div
          ...
          className="text-[32px] md:text-[44px] lg:text-[56px] leading-none"
        >
          Experience <br /> the{" "}
        ...
        <div style={{ color: "var(--text)" }} className=" text-[20px] ">
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start items-center">
          <Link href="/product">
            <div className=" shadow-[0_0_10px_rgba(129,236,255,0.3)]  cursor-pointer transform duration-300 hover:scale-105 text-black border_0 bg-[#81ecff] w-37.5 h-14 font-medium flex justify-center items-center rounded-3xl">
              SHOP NOW
            </div>
          </Link>
      ...
      <div>
        <div className="relative  group">
          <Image
            ...
            className="relative rounded-[3rem] hover:scale-105 rotate-0 lg:rotate-6 lg:group-hover:rotate-0 transition-all duration-500 max-h-150 w-auto border-10 border-[#26262666] mx-auto mb-5"
          />
        </div>
      </div>
    </div>
