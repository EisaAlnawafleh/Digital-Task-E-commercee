  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="text-center font-label uppercase tracking-widest text-on-surface-variant mb-16"
      >
        User Reviews
      </motion.h2>
      ...
      <motion.div
        ...
        className="flex flex-row flex-wrap justify-center items-center  gap-7"
      >
        <div
